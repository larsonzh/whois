...
| WP-13 | active | Phase 5 | 通过代理访问 RIR 站点 | WP-13A 契约与探针 21/21 PASS；WP-13B-1 transport、WP-13B-2 HTTP CONNECT/per-hop bypass、WP-13B-3 SOCKS5/5h 数据面均已交付，Strict `lto-auto` 九架构、Golden/referral 通过且 release 双目录同步逐字一致（实施记录见 12.2.8）；WP-13C SOCKS4/4a 未实施，TLS 九架构静态依赖仍是 13D ready 门禁（2026-08-31 更新） |
