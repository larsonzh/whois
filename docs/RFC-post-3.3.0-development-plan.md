...
| WP-13 | active | Phase 5 | 通过代理访问 RIR 站点 | WP-13A、WP-13B-1/2/3、WP-13C 已交付；WP-13D CA/构建准备与 Vx A/B 任务定义已完成编制期验收，待完整九架构/合同门禁、start-file 与启动授权（2026-09-02 更新） |
...
- WP-13D Vx A/B 定义完成编制期验收（2026-09-02）：A=`testdata/autopilot_code_step_tasks_20270805_20270811.json`（target set `8a3176bf267040b886b1cd7cbb48b545b228fa7c673094b223f5bfd4cad09957`），B=`testdata/autopilot_code_step_tasks_20270812_20270818.json`（target set `4d171a4202c4c3bbec9d945aa884a44a0fcb72b3d619362eef590cb1d279af99`，以 A 为 prerequisite）。A 负责 `wc_net_info` 自定义 transport 所有权，B 负责 HTTPS scheme、OpenSSL transport、CA/peer/hostname 验证、共享 deadline 与 CONNECT 接入。全定义检查零错误零警告，Vx 回归 PASS，默认与 TLS x86_64/win64 快编译 PASS；完整生产门禁与 start-file 尚未执行，权威清单见 `docs/RFC-proxy-access.md` 第 14 节。
