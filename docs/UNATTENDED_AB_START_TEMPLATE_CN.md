...
| `low-disturb` | 开 | 不交互，仅 relay | 想保留状态票但降低打扰 | [low-disturb smoke 样例](../testdata/unattended_start/smoke/unattended_ab_start_status_ticket_low_disturb_smoke.md) |
