...
重定向矩阵（2026-02-19）：参数化 IPv4 `pass=66 fail=0`（`out/artifacts/redirect_matrix/20260219-045555`）；11x6 `authMismatchFiles=0、errorFiles=0`（`out/artifacts/redirect_matrix_10x6/20260219-045903`）。
