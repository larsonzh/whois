...
远程编译冒烟同步 + 黄金校验（2026-02-09，lto 默认）：无告警 + lto 有告警 + Golden PASS + referral check: PASS，日志 `out/artifacts/20260209-100055`。
远程编译冒烟同步 + 黄金校验（2026-02-09，lto + debug/metrics + dns-family-mode=interleave-v4-first）：无告警 + lto 有告警 + Golden PASS + referral check: PASS，日志 `out/artifacts/20260209-100715`。
...
重定向矩阵 9x6（2026-02-09）：无权威不匹配/错误，日志 `out/artifacts/redirect_matrix_9x6/20260209-100826`。
