...
- 自检 raw/health-first/plan-a/plan-b（`--selftest-force-suspicious 8.8.8.8`）：`out/artifacts/batch_raw/20251231-151310/build_out/smoke_test.log`，`out/artifacts/batch_health/20251231-151514/build_out/smoke_test.log`，`out/artifacts/batch_plan/20251231-151718/build_out/smoke_test.log`，`out/artifacts/batch_planb/20251231-151927/build_out/smoke_test.log`。
注入视图验证示例：
```bash
