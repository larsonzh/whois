...
远程编译冒烟同步 + 黄金校验（2026-02-08，lto 默认）：无告警 + lto 有告警 + Golden PASS + referral check: PASS，日志 `out/artifacts/20260208-195133`。
远程编译冒烟同步 + 黄金校验（2026-02-08，lto + debug/metrics）：无告警 + lto 有告警 + Golden PASS + referral check: PASS，日志 `out/artifacts/20260208-195709`。
