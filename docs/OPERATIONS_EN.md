...
Latest two-pass smoke (2025-12-15 early, default remote script params):
- Default args: no warnings, Golden PASS, log `out/artifacts/20251215-003847/build_out/smoke_test.log`.
- `--debug --retry-metrics --dns-cache-stats`: no warnings, Golden PASS, log `out/artifacts/20251215-004211/build_out/smoke_test.log`.

Batch strategy goldens (raw/health-first/plan-a/plan-b, all PASS, 2025-12-15 early):
...
Selftest goldens (`--selftest-force-suspicious 8.8.8.8`, all four strategies PASS, 2025-12-15 early):
