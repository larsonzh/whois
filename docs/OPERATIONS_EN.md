...
Remote build smoke sync + golden (2026-02-09, LTO default): no warnings + LTO warnings + Golden PASS + referral check PASS, log `out/artifacts/20260209-055319`.
Remote build smoke sync + golden (2026-02-09, LTO + debug/metrics + dns-family-mode=interleave-v4-first): no warnings + LTO warnings + Golden PASS + referral check PASS, log `out/artifacts/20260209-055936`.
...
Redirect matrix 9x6 (2026-02-09): no authority mismatches/errors, log `out/artifacts/redirect_matrix_9x6/20260209-060148`.
