...
Stress plan note (2025-12-31): manual long-line/dense-continuation/CRLF scenarios (fold-unique + grep block) now pass with no truncation/crash; latest remote smoke + golden logs: `out/artifacts/20251231-142438` (default params, PASS).
