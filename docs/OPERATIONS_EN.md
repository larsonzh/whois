...
Remote build smoke sync + golden (2026-02-08, LTO default): no warnings + LTO warnings + Golden PASS + referral check PASS, log `out/artifacts/20260208-195133`.
Remote build smoke sync + golden (2026-02-08, LTO + debug/metrics): no warnings + LTO warnings + Golden PASS + referral check PASS, log `out/artifacts/20260208-195709`.
