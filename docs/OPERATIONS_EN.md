...
Latest two-pass smoke (2025-12-18 early, default remote script params):
- Default args: no warnings, Golden PASS, log `out/artifacts/20251218-012503/build_out/smoke_test.log`.
- `--debug --retry-metrics --dns-cache-stats`: no warnings, Golden PASS, log `out/artifacts/20251218-012710/build_out/smoke_test.log`.

Batch strategy goldens (raw/health-first/plan-a/plan-b, all PASS, 2025-12-18 early):
...
Selftest goldens (`--selftest-force-suspicious 8.8.8.8`, all four strategies PASS, 2025-12-18 early):
