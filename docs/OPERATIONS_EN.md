...
Remote build smoke sync + golden (2026-02-08, LTO default): no warnings + LTO warnings + Golden PASS + referral check PASS, log `out/artifacts/20260208-141059`.
Remote build smoke sync + golden (2026-02-08, LTO + debug/metrics): no warnings + LTO warnings + Golden PASS + referral check PASS, log `out/artifacts/20260208-141653`.
Batch strategy goldens (2026-02-08, LTO): raw/health-first/plan-a/plan-b PASS, logs `out/artifacts/batch_{raw,health,plan,planb}/20260208-14*`.
Selftest goldens (2026-02-08, LTO + `--selftest-force-suspicious 8.8.8.8`): raw/health-first/plan-a/plan-b PASS, logs `out/artifacts/batch_{raw,health,plan,planb}/20260208-14*/15*`.
Redirect matrix 9x6 (2026-02-08): `45.71.8.0/22` hit rate-limit on APNIC start; authority fell back to error, log `out/artifacts/redirect_matrix_9x6/20260208-152209`.
