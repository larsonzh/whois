...
#### 23.92 下次开工清单（无人值守超高密度档：开发四轮 + 复检四轮，提速模式，2027-01-16 ~ 2027-01-22，串行第 35 份，Checklist A，草案）
...
#### 23.93 下次开工清单（无人值守超高密度档：开发四轮 + 复检四轮，提速模式，2027-01-23 ~ 2027-01-31，串行第 36 份，Checklist B，草案）
...
- 当前策略基线：`RUN_MODE=foreground-visible`、`ENTRY_MODE=single-param-fastmode`、`A_FAILURE_BLOCKS_B=true`、`B_START_REQUIRES_A_PASS_WITH_SNAPSHOT=true`、`AI_CHAT_POLICY_DELIVERY_PRIMARY=ipc`。
- 预检基线：（待生成启动文件后由 launch-ready 预检回填 `PRECHECK_*`）。
