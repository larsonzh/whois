...
- 静态多架构 / Static multi-arch（GitHub 直链）：
	- [whois-aarch64](https://github.com/larsonzh/whois/releases/download/v3.2.5/whois-aarch64)
	- [whois-armv7](https://github.com/larsonzh/whois/releases/download/v3.2.5/whois-armv7)
	- [whois-loongarch64](https://github.com/larsonzh/whois/releases/download/v3.2.5/whois-loongarch64)
	- [whois-mips64el](https://github.com/larsonzh/whois/releases/download/v3.2.5/whois-mips64el)
	- [whois-mipsel](https://github.com/larsonzh/whois/releases/download/v3.2.5/whois-mipsel)
	- [whois-x86](https://github.com/larsonzh/whois/releases/download/v3.2.5/whois-x86)
	- [whois-x86_64](https://github.com/larsonzh/whois/releases/download/v3.2.5/whois-x86_64)

- CI glibc 构建 / CI glibc build：
	- [whois-x86_64-gnu](https://github.com/larsonzh/whois/releases/download/v3.2.5/whois-x86_64-gnu)

- 校验 / Checksums：
	- [SHA256SUMS.txt](https://github.com/larsonzh/whois/releases/download/v3.2.5/SHA256SUMS.txt)
