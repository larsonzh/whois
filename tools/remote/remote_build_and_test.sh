...
WHOIS_TLS_ESC="$WHOIS_TLS"
WHOIS_TLS_ESC=${WHOIS_TLS_ESC//$SQUOTE_CHAR/$SQUOTE_ESC}
OPENSSL_STATIC_VERSION_ESC="$OPENSSL_STATIC_VERSION"
OPENSSL_STATIC_VERSION_ESC=${OPENSSL_STATIC_VERSION_ESC//$SQUOTE_CHAR/$SQUOTE_ESC}
OPENSSL_STATIC_ROOT_ESC="$OPENSSL_STATIC_ROOT"
OPENSSL_STATIC_ROOT_ESC=${OPENSSL_STATIC_ROOT_ESC//$SQUOTE_CHAR/$SQUOTE_ESC}
...
echo "[remote_build]   WHOIS_TLS='$WHOIS_TLS_ESC'"
echo "[remote_build]   OPENSSL_STATIC_VERSION='$OPENSSL_STATIC_VERSION_ESC'"
echo "[remote_build]   OPENSSL_STATIC_ROOT='$OPENSSL_STATIC_ROOT_ESC'"
