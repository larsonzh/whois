...
$pass = ($triggerResult.ExitCode -eq 0 -and $dispatchResult.ExitCode -eq 0)
...
Write-Output ('[ROUTE-GUARD-SMOKE-SUITE] trigger_exit={0} dispatch_exit={1}' -f $triggerResult.ExitCode, $dispatchResult.ExitCode)
