...
$gitGuardSuffixEn = ' During unattended execution, do not run git checkout or git commit or git push unless explicitly authorized by the user in the same turn.'
