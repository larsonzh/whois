...
$crossRoundRepairStatusEn = if ($taskStaticCrossRoundRepairEnabled) {
    '[Cross-round repair enabled] For task-static faults, keep one transaction candidate across the failing round and all later D rounds through D4. Do not Promote between rounds. Run Validate -ValidateThroughRound D4, then Promote exactly once after the complete sequence passes.'
}
else {
