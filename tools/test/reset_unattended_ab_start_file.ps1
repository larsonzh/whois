...
function Get-ResetValue {
    ...
    switch -Regex ($Key) {
        ...
        '^A_PASS_CONCLUSION_B_STARTED_TICKET_(SIGNATURE|AT)$' { return '' }
        '^LAST_INCIDENT_GENERATION_(SIGNATURE|TICKET_AT)$' { return '' }
        '^(A_LAUNCH_PID|B_LAUNCH_PID|WATCH_(PARENT_PID|LAUNCH_PID|LAST_EXIT_PID))$' { return '0' }
        '^(A_RUN_DIR|B_RUN_DIR|B_TASK_FIRST_START_AT)$' { return '' }
...
$defaultSelectorText = 'PRECHECK_*;START_ROUND;B_RESTORE_FROM_A_SNAPSHOT;NETWORK_PRECHECK_LAST_RESULT;NETWORK_PRECHECK_LAST_AT;NETWORK_PRECHECK_LAST_REASON;A_SUCCESS_SNAPSHOT_FINAL_STATUS;A_SUCCESS_SNAPSHOT_SUMMARY;A_SUCCESS_SNAPSHOT_SOURCE_STATE;A_FINAL_STATUS;B_FINAL_STATUS;SESSION_FINAL_STATUS;SESSION_CLOSED;SESSION_CLOSED_AT;SESSION_CLOSED_REASON;SESSION_FINAL_NOTES;AI_SESSION_BLOCKING_WATCH_NOTES;RESTART_EVIDENCE_NOTES;A_LAUNCH_PID;B_LAUNCH_PID;B_TASK_FIRST_START_AT;A_RUN_DIR;B_RUN_DIR;A_PASS_CONCLUSION_B_STARTED_TICKET_SIGNATURE;A_PASS_CONCLUSION_B_STARTED_TICKET_AT;LAST_INCIDENT_GENERATION_SIGNATURE;LAST_INCIDENT_GENERATION_TICKET_AT;WATCH_LAUNCH_PID;WATCH_PARENT_PID;WATCH_LAST_START_AT;WATCH_LAST_EXIT_PID;WATCH_LAST_EXIT_AT;LOCAL_GUARD_WAIT_FOR_MANUAL_RESTART;LOCAL_GUARD_AUTO_RECOVER_B;LOCAL_GUARD_SCRIPT_SELF_HEAL_ENABLED;LOCAL_GUARD_RESTART_REQUIRES_CONFIRM;LOCAL_GUARD_RESTART_APPROVED;LOCAL_GUARD_WRITE_HANDLED_ARTIFACTS;AI_CHAT_DISPATCH_ALLOW_RUNNING_STATUS_MESSAGE_OVERRIDE;LOCAL_GUARD_POLL_STATUS_REPORT_EVENTS;LOCAL_GUARD_POLL_DRAIN_SAFE_EVENTS;LOCAL_GUARD_POLL_BARRIER_EVENTS;LOCAL_GUARD_POLL_RESTART_SENSITIVE_EVENTS;LOCAL_GUARD_POLL_CONTRACT_GATE_EVENTS;LOCAL_GUARD_POLL_EVENT_POLICY_STRICT;LOCAL_GUARD_POLL_STATUS_REPORT_INCLUDE_TICKET_CHAIN_CHECK;LOCAL_GUARD_POLL_STATUS_REPORT_INCLUDE_MAIN_PROCESS_HEALTH_CHECK;LOCAL_GUARD_POLL_STATUS_REPORT_ENABLE_MAIN_PROCESS_SELF_HEAL;LOCAL_GUARD_STATUS_ONLY_AUTOFLOW_EXEC_TOKEN;TASK_STATIC_PRECHECK_FAIL_ON_WARNINGS;TASK_STATIC_CROSS_ROUND_REPAIR_ENABLED;EXTERNAL_TRIGGER_EXECUTE;EXTERNAL_TRIGGER_COMMAND'
