...
$oneClickSource = Get-Content -LiteralPath $oneClickScript -Raw
$remoteBuildIndex = $oneClickSource.IndexOf('Invoke-GitBash $rbCmd -Environment $buildEnvironment')
