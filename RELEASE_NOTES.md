...
中文摘要 / Chinese summary
- 发布与真实演练（2026-08-25）：版本号提升至 3.3.1，同步 RELEASE_NOTES 3.3.1 段、README 标题/发布列表/速览与 `docs/release_bodies/v3.3.1.md`；WP-01 真实 one-click 发布演练 PASS（build+verify → statics 同步/提交 → annotated tag v3.3.1 指向最终静态产物提交 `4357c6a0` → GitHub/Gitee Release 更新，Gitee body 更新 exit=0），全程无故障；WP-01 关闭（done）。
