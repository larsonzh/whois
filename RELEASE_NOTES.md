...
- 发布准备（2026-08-25）：版本号提升至 3.3.1，同步 RELEASE_NOTES 3.3.1 段、README 标题/发布列表/速览与 `docs/release_bodies/v3.3.1.md`；正式发布候选验证、Golden/referral 复跑与 tag 指向演练由 WP-01 one-click 预发布窗口完成（WP-01 保持 active）。
...
English summary
- Release preparation (2026-08-25): version bumped to 3.3.1, with the RELEASE_NOTES 3.3.1 section, README title/release list/what's-new, and `docs/release_bodies/v3.3.1.md` synchronized; the formal release-candidate verification and tag-pointing rehearsal will be completed by the WP-01 one-click prerelease window (WP-01 stays active).
