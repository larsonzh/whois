...
- DNS 家族模式开关：新增 `--dns-family-mode interleave-v4-first|interleave-v6-first|seq-v4-then-v6|seq-v6-then-v4`，优先级低于 `--ipv4-only/--ipv6-only`、`--prefer-ipv4-ipv6/--prefer-ipv6-ipv4`、`--prefer-ipv4/--prefer-ipv6`，调试下输出 `[DNS-CAND] mode=... start=...` 观察起始族。2025-12-21 远程冒烟 + 黄金全矩阵均无告警通过：默认 `out/artifacts/20251221-100318/...`，`--debug --retry-metrics --dns-cache-stats` `out/artifacts/20251221-100617/...`，批量 raw/health-first/plan-a/plan-b 分别 `out/artifacts/batch_raw/20251221-100814/...`、`batch_health/20251221-101032/...`、`batch_plan/20251221-101248/...`、`batch_planb/20251221-101508/...`，自检轮（`--selftest-force-suspicious 8.8.8.8`）`batch_raw/20251221-101848/...`、`batch_health/20251221-102015/...`、`batch_plan/20251221-102132/...`、`batch_planb/20251221-102253/...`。
