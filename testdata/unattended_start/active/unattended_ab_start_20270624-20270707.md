...
PRECHECK_AT=2026-08-29 12:39:29
...
PRECHECK_WORKSPACE_STATUS_DETAIL= M RELEASE_NOTES.md |  M docs/RFC-post-3.3.0-development-plan.md |  M docs/RFC-proxy-access.md |  M tools/test/proxy_protocol_spike.py | ... (+3 more)
...
PRECHECK_NOTES=local_related=pass; workspace= M RELEASE_NOTES.md |  M docs/RFC-post-3.3.0-development-plan.md |  M docs/RFC-proxy-access.md |  M tools/test/proxy_protocol_spike.py | ... (+3 more); remote_lock=absent; start_gate=READY; operator=Copilot
