...
static const char* const k_diagnostics_lines[] = {
    ...
    "      --enable-preclass-early-converge  Enable Phase C reserved/special early converge (default: on)",
    ...
    int default_debug)
{
    ...
    printf("      --rate-limit-retries N  App-layer retries for temporary denied/rate-limit responses (default: 2, range: 0..10)\n");
    printf("      --rate-limit-retry-interval-ms M  Wait between app-layer retries in ms (default: 2500)\n\n");
