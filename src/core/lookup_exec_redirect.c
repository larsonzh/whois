...
static void wc_lookup_exec_handle_apnic_erx_logic(
    ...
    int apnic_transfer_to_apnic = wc_lookup_exec_run_apnic_transfer_step(
        ctx,
        body,
        header_host,
        header_is_iana,
...
static int wc_lookup_exec_should_handle_lacnic_header_redirect(
    const struct wc_lookup_exec_redirect_ctx* ctx) {
    return wc_lookup_exec_is_current_rir_lacnic(ctx);
}
...
static void wc_lookup_exec_handle_lacnic_header_redirect(
    ...
    if (wc_lookup_exec_should_handle_lacnic_header_redirect(ctx)) {
...
static void wc_lookup_exec_update_apnic_suppress_current(
    ...
    *apnic_erx_suppress_current = wc_lookup_exec_base_apnic_suppress_current(ctx, body);
...
static int wc_lookup_exec_apnic_stop_target_ref_empty(
    const struct wc_lookup_exec_redirect_ctx* ctx);
static int wc_lookup_exec_apnic_stop_target_need_redirect(int need_redir_eval);
...
static int wc_lookup_exec_should_apply_apnic_stop_on_target(
    ...
    return wc_lookup_exec_apnic_stop_target_need_redirect(need_redir_eval);
}
