...
static Config g_client_config = {
    ...
    .retry_jitter_ms = 300,
    .retry_all_addrs = 0,
    .app_retry_rate_limit = 2,
    .app_retry_interval_ms = 2500,
    .retry_metrics = 0,
    .pacing_disable = 0,
    ...
    .preclass_action_tier = 0,
    .preclass_action_list = NULL,
    ...
    .preclass_early_converge_enable = 1,
    .fold_unique = 0,
    .dns_neg_ttl = 10,
    ...
    .prefer_ipv4 = 0,
    .prefer_ipv6 = 1,
    .ip_pref_mode = WC_IP_PREF_MODE_FORCE_V6_FIRST,
    .rir_pref_iana = WC_RIR_IP_PREF_UNSET,
    .rir_pref_arin = WC_RIR_IP_PREF_UNSET,
    .rir_pref_ripe = WC_RIR_IP_PREF_UNSET,
    .rir_pref_apnic = WC_RIR_IP_PREF_UNSET,
    .rir_pref_lacnic = WC_RIR_IP_PREF_UNSET,
    .rir_pref_afrinic = WC_RIR_IP_PREF_UNSET,
    .rir_pref_verisign = WC_RIR_IP_PREF_UNSET,
    .dns_family_mode = WC_DNS_FAMILY_MODE_SEQUENTIAL_V6_THEN_V4,
    .dns_family_mode_first = WC_DNS_FAMILY_MODE_INTERLEAVE_V6_FIRST,
